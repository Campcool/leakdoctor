...
最後更新：2026-07-19（by Codex）— 冷氣／水管症狀型搜尋內容與 Google Ads 關鍵字
...
- 共用資源快取版本升為 `20260719b`；420px 以下的手機底部列隱藏說明文字，兩顆 CTA 平均分寬，避免窄螢幕溢出。部署前需驗證 390×844 與 1366×768 的 Header、雙 CTA、表單收合、六色服務卡、水平溢出與七個主要入口。
