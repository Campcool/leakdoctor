...
### 🟠 高價值，AI 可做
- [ ] **LINE Bot 後台**（規劃 v2.1 完成，`docs/BOT-PLAN.md`）：待①其他 AI 評估意見 ②業主完成 §13 前置作業（建 repo/LINE 金鑰/Cloudflare/API key）即可從 P1 開工；拆帳比例談定前不擋 P1/P2。後端放新私有 repo `huitailang-bot`，不放本 repo
