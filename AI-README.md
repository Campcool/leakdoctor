...
最後更新：2026-07-16（by Codex）— PC 三層服務導覽比例、對齊與路徑流光
...
### 2026-07-18（Claude・幼兒園官網研究，僅文件不動網站）
- 業主準備製作幼兒園（含安親班）官網，先做臺灣主要幼兒園官網的發散式研究：何嘉仁、吉的堡、三之三、快樂瑪麗安、康橋五大品牌＋多個單園/公立園網站的功能與設計重點。
- 研究成果存於 `docs/KINDERGARTEN-SITE-RESEARCH.md`：常見功能歸納（分齡課程、預約參觀為主轉換、分園查詢、師資、環境寫真、親職專欄、電子聯絡簿）、設計重點（真實照片建立信任、精簡表單、手機/LINE 優先、地區 SEO）、新站資訊架構建議、法規紅線（幼兒園不得以全外語教學宣傳、安親班立案名稱須一致）。
- 未修改任何網站程式或頁面；新站建議獨立 repo／網域／LINE 帳號，勿與灰汰郎混用。
...
- [ ] **第一波真實案例補圖**：居家清潔已先上架 3 組（case03／08／11），仍建議再補 3 組；洗衣機 4 組、冷氣 4 組尚待業主提供。AI 依 §3「案例照片上傳與上架 SOP」壓縮、去識別並上架。
