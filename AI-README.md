...
⚠️ **需在 Google Search Console 手動操作**：重新提交 sitemap（33 網址），
並對這 7 頁請求重新索引。它們先前被標為 noindex，Google 不會自己回頭再看。
...
- [ ] Google Search Console 提交新 sitemap（2026-08-17 最終為 **33 網址**：7 個地區頁恢復索引，僅排除 areas/cases/team 3 個 noindex 頁；先前若提交過 36 或 26 網址版本，請重新提交覆蓋）＋**對 7 個地區頁請求重新索引**（它們先前標 noindex，Google 不會自己回頭再看）＋對改名頁面請求重新索引（仍需業主手動在 GSC 操作）
...
- [x] 全站 favicon 已於 2026-07-20 改為透明滿版刷子符號，並同步 16／32／180／192／ICO 版本與 cache key。
